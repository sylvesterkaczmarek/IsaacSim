...
class SdfShapePrim(GeometryPrim):
    ...
    Args:
        ...
        collisions: Set to True if the geometry prims already have or
        ...
        contact_filter_prim_paths_expr: A list of filter expressions that allow for tracking
    ...
    def _apply_sdf_schema(self, prim_at_path: object) -> None:
        """Applies SDF collision schemas to a prim and sets its mesh collision approximation to sdf.

        Args:
            prim_at_path: Prim to apply SDF collision schemas to.
        """
    ...
    def is_physics_handle_valid(self) -> bool:
        ...
        Returns:
            True if physics is initialized for the view, otherwise False.
        """
        return self._physics_view is not None

    def initialize(self, physics_sim_view: omni.physics.tensors.SimulationView = None) -> None:
        """Creates a physics simulation view and a SDF shape view in PhysX.
    ...
    def get_sdf_and_gradients(
        ...
        """Gets the SDF values and gradients of the query points.

        Args:
            points: Points represented in the local frames of meshes to query for SDF and gradients.
    ...
    def get_sdf_margins(
        ...
        """Gets SDF margin values for prims in the view.

        Args:
            indices: Indices to specify which prims to query. Shape (M,).
                Where M <= size of the encapsulated prims in the view.
            clone: Included for API compatibility.
    ...
    def get_sdf_narrow_band_thickness(
        ...
        """Gets SDF collision narrow band thickness values for prims in the view.
    ...
    def get_sdf_subgrid_resolution(
        ...
        """Gets SDF collision subgrid resolution values for prims in the view.
    ...
    def get_sdf_resolution(
        ...
        """Gets SDF collision resolution values for prims in the view.
    ...
    def set_sdf_margins(
        ...
        Args:
            values: SDF margins to set. Shape (M,).
    ...
    def set_sdf_narrow_band_thickness(
        ...
        Args:
            values: SDF narrow band thicknesses to set. Shape (M,).
            indices: Indices to specify which prims to manipulate. Shape (M,).
                Where M <= size of the encapsulated prims in the view.
        """
        indices = self._backend_utils.resolve_indices(indices, self.count, self._device)
    ...
    def set_sdf_subgrid_resolution(
        ...
        Args:
            values: SDF subgrid resolutions to set. Shape (M,).
            indices: Indices to specify which prims to manipulate. Shape (M,).
                Where M <= size of the encapsulated prims in the view.
        """
        indices = self._backend_utils.resolve_indices(indices, self.count, self._device)
    ...
    def set_sdf_resolution(
        ...
        Args:
            values: SDF resolutions to set. Shape (M,).
            indices: Indices to specify which prims to manipulate. Shape (M,).
                Where M <= size of the encapsulated prims in the view.
        """
        indices = self._backend_utils.resolve_indices(indices, self.count, self._device)
