...
"""Helper class for interpolating paths generated by PathPlanner instances for robot articulations.
...
class PathPlannerVisualizer:
    ...
    def get_active_joints_subset(self) -> ArticulationSubset:
        """View into active joints.

        Returns:
            Robot states for active joints in an order compatible with the PathPlanner.
        """
        return self._active_joints_view

    def get_watched_joints_subset(self) -> ArticulationSubset:
        """View into watched joints.

        Returns:
            Robot states for watched joints in an order compatible with the PathPlanner.
        """
    ...
    def get_path_planner(self) -> PathPlanner:
        """The PathPlanner that is being used to generate paths.

        Returns:
            An instance of the PathPlanner interface for generating sparse paths to a target pose.
        """
