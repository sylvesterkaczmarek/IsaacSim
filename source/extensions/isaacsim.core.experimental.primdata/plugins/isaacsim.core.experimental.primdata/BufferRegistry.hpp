...
public:
    ...
    /// Physics tensor view handles (created via the engine-agnostic tensor API).
    omni::physics::tensors::IArticulationView* articulationView = nullptr;
    omni::physics::tensors::IRigidBodyView* rigidBodyView = nullptr;
