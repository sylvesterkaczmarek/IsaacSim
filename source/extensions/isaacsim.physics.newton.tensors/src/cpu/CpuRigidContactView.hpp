...
#include "base/BaseRigidContactView.hpp"
...
public:
     ...
     * @param[out] frictionForceTensor Destination tensor that receives tangential force values.
     * @param[out] contactPointTensor Destination tensor that receives contact point values.
     * @param[out] contactCountTensor Destination tensor that receives contact count values.
     * @param[out] contactStartIndicesTensor Destination tensor that receives contact start indices values.
     * @param[in] dt Time step, in seconds.
     * @return True on success; false otherwise.
     */
