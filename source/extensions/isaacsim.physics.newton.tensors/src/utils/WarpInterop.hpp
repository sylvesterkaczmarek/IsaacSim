...
/// Device Agnostic function for transferring data from a warp array to a tensor array.
/// Both the warp array and tensor array can reside on either CPU or GPU.
