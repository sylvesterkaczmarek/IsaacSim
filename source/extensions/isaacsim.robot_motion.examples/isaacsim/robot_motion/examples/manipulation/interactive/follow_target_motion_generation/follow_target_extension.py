...
"""Interactive Follow Target example extension using Franka and cuMotion RMPflow."""
...
from isaacsim.gui.components import btn_builder, state_btn_builder
from isaacsim.robot_motion.examples.manipulation.interactive.follow_target_motion_generation import FollowTarget


class FollowTargetExtension(omni.ext.IExt):
    """Extension for the Follow Target manipulation example.

    Provides an interactive demonstration of a Franka robot following a target cube using
    ...
    def on_startup(self, ext_id: str) -> None:
        ...
        ui_kwargs = {
            ...
            "overview": (
                "This Example shows how to follow a target using a Franka robot with cuMotion RMPflow.\n\n"
