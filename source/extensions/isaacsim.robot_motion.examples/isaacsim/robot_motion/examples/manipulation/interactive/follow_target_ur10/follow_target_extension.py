...
"""Interactive UR10 Follow Target example using cuMotion RMPflow."""
...
from isaacsim.robot_motion.examples.manipulation.interactive.follow_target_ur10 import FollowTarget
...
class FollowTargetExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id: str) -> None:
        ...
        """
        self.example_name = "Follow Target (UR10)"
        self.category = "Manipulation"

        ui_kwargs = {
            "ext_id": ext_id,
            "file_path": os.path.abspath(__file__),
            "title": "Follow Target (UR10)",
