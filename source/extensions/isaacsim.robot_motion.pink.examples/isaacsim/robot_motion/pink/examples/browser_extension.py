...
"""Shared Robotics Examples browser registration for PINK examples."""
...
class BrowserExampleExtension:
    """Base extension that presents a PINK UI builder in Robotics Examples."""

    example_name = ""
    category = "Motion Generation/PINK"
    observer_name = ""
