...
class CustomCollapsableFrame(CollapsableFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Capture height before super().__init__ so _create_frame (called by super)
        # can use it.  Default 0 means auto-size (existing behaviour).
        self._frame_height = kwargs.pop("height", 0)
