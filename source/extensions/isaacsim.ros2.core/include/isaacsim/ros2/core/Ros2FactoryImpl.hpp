 ...
 *
 * @return std::unique_ptr<isaacsim::ros2::core::Ros2Factory> Unique pointer to the created factory
 */
#ifdef _MSC_VER
__declspec(dllexport) std::unique_ptr<isaacsim::ros2::core::Ros2Factory> createFactory();
#else
 ...
 *
 * @return isaacsim::ros2::core::Ros2Factory* Raw pointer to the created factory
 */
#ifdef _MSC_VER
extern "C" __declspec(dllexport) isaacsim::ros2::core::Ros2Factory* createFactoryC();
#else
extern "C" isaacsim::ros2::core::Ros2Factory* createFactoryC();
#endif
