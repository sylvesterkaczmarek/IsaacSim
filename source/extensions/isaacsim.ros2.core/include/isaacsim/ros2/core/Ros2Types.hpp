 ...
 * @details
 * Defines the various types of messages that can be handled by the ROS 2 core,
...
public:
    ...
    /**
     * @brief Retrieves the ROS domain ID used by this initialized context.
     * @details
     * Returns the effective ROS domain ID after environment-variable/default
     * resolution.
     *
     * @return ROS domain ID, or SIZE_MAX if the context is invalid or the domain
     *         cannot be queried.
     */
    virtual size_t getDomainId() = 0;
};
