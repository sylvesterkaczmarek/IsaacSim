...
if(NOT DEFINED SOURCE OR NOT IS_DIRECTORY "${SOURCE}")
    message(FATAL_ERROR "CopyPythonPackage requires an existing SOURCE directory: ${SOURCE}")
endif()
if(NOT DEFINED DESTINATION OR DESTINATION STREQUAL "")
    message(FATAL_ERROR "CopyPythonPackage requires DESTINATION")
endif()
...
file(COPY "${SOURCE}/"
    ...
    PATTERN "generatedSchema.usda" EXCLUDE
)
