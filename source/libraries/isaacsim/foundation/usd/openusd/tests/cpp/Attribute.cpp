...
TEST_SUITE("Attribute")
{
    ...
    TEST_CASE("getPrimAttributeTypeName")
    {
        std::string usdPath =
            isaacsim::common::test::resolveResourcePath("isaacsim.foundation.usd.openusd", "attributes.usda");
    ...
    TEST_CASE("getPrimAttributeNames")
    {
        std::string usdPath =
            isaacsim::common::test::resolveResourcePath("isaacsim.foundation.usd.openusd", "attributes.usda");
        int64_t stageId = openStage(usdPath);
