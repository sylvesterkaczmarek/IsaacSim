...
TEST_SUITE("Stage")
{
    ...
    {
        std::string usdPath =
            isaacsim::common::test::resolveResourcePath("isaacsim.foundation.usd.openusd", "scene.usda");
        // Open the stage
    ...
    TEST_CASE("saveStage")
    {
        ...
        const std::string savePath = "isaacsim_foundation_usd_openusd_test.usda";
    ...
    TEST_CASE("getStageUnits | setStageUnits")
    {
        int64_t stageId = createStage();
    ...
    TEST_CASE("getStageUpAxis | setStageUpAxis")
    {
        int64_t stageId = createStage();
    ...
    TEST_CASE("getStageTimeCode | setStageTimeCode")
    {
        int64_t stageId = createStage();
    ...
    TEST_CASE("removePrim")
    {
        ...
        SUBCASE("Delete an ancestral prim (defined inside the reference)")
        {
            ...
            addReferenceToStage(stageId, "/World/Reference", usdPath);
