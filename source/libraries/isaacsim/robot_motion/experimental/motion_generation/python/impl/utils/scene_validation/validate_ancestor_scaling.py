...
def _prim_scaling_is_valid(prim: object) -> bool:
    ...
    if "xformOp:scale" in attribute_names:
        local_scale = np.array(prim_utils.get_prim_attribute_value(prim, "xformOp:scale"))
